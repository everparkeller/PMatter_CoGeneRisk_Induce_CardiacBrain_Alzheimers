########################################
### Figure 2C: SAM Ejection Fraction ###
########################################
...
Figure2A.RP <- resid_panel(model1.A6)
...
Figure2A.3 <- ggplot(data = fig.2.data.1, aes(x = Genotype, y = !!sym(Outcome), fill = Exposure)) +
