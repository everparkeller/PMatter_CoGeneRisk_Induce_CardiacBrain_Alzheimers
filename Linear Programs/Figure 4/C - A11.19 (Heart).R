...
text.corner.1 <- 0.015
text.corner.2 <- 0.008
ylab.statement <- "A11-19 Integrated Density\n(signal : total protein)"
yaxis.min <- 0
yaxis.max <- 0.5
yaxis.breaks <- 0.02

Figure4A.2 <- ggplot(data = fig.4a.data.1[which(fig.4a.data.1$Organ == "Heart"),], aes(x = Genotype, y = !!sym(Outcome), fill = Exposure)) +
  ...
  geom_text(aes(x = 2.13, y = 0.155, label = "* Sex"), color = "black", size = 2.5, vjust = 0, hjust = 0) +
  geom_text(aes(x = 2.13, y = 0.16, label = ""))



# Stratified Sex
AD.FA.Max.M <- max(as.matrix(fig.4a.data.1[,Outcome])[which(fig.4a.data.1$Exposure == "FA" & fig.4a.data.1$Genotype == "AD" & fig.4a.data.1$Sex == "M" & fig.4a.data.1$Organ == "Heart")], na.rm = TRUE)
AD.PM.Max.M <- max(as.matrix(fig.4a.data.1[,Outcome])[which(fig.4a.data.1$Exposure == "PM" & fig.4a.data.1$Genotype == "AD" & fig.4a.data.1$Sex == "M" & fig.4a.data.1$Organ == "Heart")], na.rm = TRUE)
WT.FA.Max.M <- max(as.matrix(fig.4a.data.1[,Outcome])[which(fig.4a.data.1$Exposure == "FA" & fig.4a.data.1$Genotype == "WT" & fig.4a.data.1$Sex == "M" & fig.4a.data.1$Organ == "Heart")], na.rm = TRUE)
WT.PM.Max.M <- max(as.matrix(fig.4a.data.1[,Outcome])[which(fig.4a.data.1$Exposure == "PM" & fig.4a.data.1$Genotype == "WT" & fig.4a.data.1$Sex == "M" & fig.4a.data.1$Organ == "Heart")], na.rm = TRUE)

AD.FA.Max.F <- max(as.matrix(fig.4a.data.1[,Outcome])[which(fig.4a.data.1$Exposure == "FA" & fig.4a.data.1$Genotype == "AD" & fig.4a.data.1$Sex == "F" & fig.4a.data.1$Organ == "Heart")], na.rm = TRUE)
AD.PM.Max.F <- max(as.matrix(fig.4a.data.1[,Outcome])[which(fig.4a.data.1$Exposure == "PM" & fig.4a.data.1$Genotype == "AD" & fig.4a.data.1$Sex == "F" & fig.4a.data.1$Organ == "Heart")], na.rm = TRUE)
WT.FA.Max.F <- max(as.matrix(fig.4a.data.1[,Outcome])[which(fig.4a.data.1$Exposure == "FA" & fig.4a.data.1$Genotype == "WT" & fig.4a.data.1$Sex == "F" & fig.4a.data.1$Organ == "Heart")], na.rm = TRUE)
WT.PM.Max.F <- max(as.matrix(fig.4a.data.1[,Outcome])[which(fig.4a.data.1$Exposure == "PM" & fig.4a.data.1$Genotype == "WT" & fig.4a.data.1$Sex == "F" & fig.4a.data.1$Organ == "Heart")], na.rm = TRUE)
...
text.corner.1 <- 0.015
text.corner.2 <- 0.008
ylab.statement <- "A11-19 Integrated Density (signal : total protein)"
yaxis.min <- 0
yaxis.max <- 0.5
yaxis.breaks <- 0.02

Figure4A.2 <- ggplot(data = fig.4a.data.1[which(fig.4a.data.1$Organ == "Heart"),], aes(x = Concat.G.S, y = !!sym(Outcome), fill = Exposure)) +
  stat_boxplot(position = position_dodge(width = 0.7), geom = "errorbar", width = 0.2, size = 0.4) + 
  ...
  geom_segment(data = subset(fig.4a.data.1, Sex == "F"),
               aes(x = 0.824, xend = 1.175, y = max(as.matrix(fig.4a.data.1[,Outcome]), na.rm = TRUE) + seg.max.1, yend = max(as.matrix(fig.4a.data.1[,Outcome]), na.rm = TRUE) + seg.max.1), 
               color = "black", size = 0.4, lineend = "round") + 
  geom_segment(data = subset(fig.4a.data.1, Sex == "F"),
               aes(x = 0.825, xend = 0.825, y = max(as.matrix(fig.4a.data.1[,Outcome]), na.rm = TRUE) + seg.max.1, yend = AD.FA.Max.F + seg.max.2), 
               color = "black", size = 0.4, lineend = "round") +
  geom_segment(data = subset(fig.4a.data.1, Sex == "F"),
               aes(x = 1.175, xend = 1.175, y = max(as.matrix(fig.4a.data.1[,Outcome]), na.rm = TRUE) + seg.max.1, yend = AD.PM.Max.F + seg.max.2), 
               color = "black", size = 0.4, lineend = "round") +
  geom_segment(data = subset(fig.4a.data.1, Sex == "F"),
               aes(x = 1.824, xend = 2.175, y = max(as.matrix(fig.4a.data.1[,Outcome]), na.rm = TRUE) + seg.max.1, yend = max(as.matrix(fig.4a.data.1[,Outcome]), na.rm = TRUE) + seg.max.1), 
               color = "black", size = 0.4, lineend = "round") + 
  geom_segment(data = subset(fig.4a.data.1, Sex == "F"),
               aes(x = 1.825, xend = 1.825, y = max(as.matrix(fig.4a.data.1[,Outcome]), na.rm = TRUE) + seg.max.1, yend = WT.FA.Max.F + seg.max.2), 
               color = "black", size = 0.4, lineend = "round") +
  geom_segment(data = subset(fig.4a.data.1, Sex == "F"),
               aes(x = 2.175, xend = 2.175, y = max(as.matrix(fig.4a.data.1[,Outcome]), na.rm = TRUE) + seg.max.1, yend = WT.PM.Max.F + seg.max.2), 
               color = "black", size = 0.4, lineend = "round") + 
  geom_segment(data = subset(fig.4a.data.1, Sex == "M"),
               aes(x = 0.824, xend = 1.175, y = max(as.matrix(fig.4a.data.1[,Outcome]), na.rm = TRUE) + seg.max.1, yend = max(as.matrix(fig.4a.data.1[,Outcome]), na.rm = TRUE) + seg.max.1), 
               color = "black", size = 0.4, lineend = "round") + 
  geom_segment(data = subset(fig.4a.data.1, Sex == "M"),
               aes(x = 0.825, xend = 0.825, y = max(as.matrix(fig.4a.data.1[,Outcome]), na.rm = TRUE) + seg.max.1, yend = AD.FA.Max.M + seg.max.2), 
               color = "black", size = 0.4, lineend = "round") +
  geom_segment(data = subset(fig.4a.data.1, Sex == "M"),
               aes(x = 1.175, xend = 1.175, y = max(as.matrix(fig.4a.data.1[,Outcome]), na.rm = TRUE) + seg.max.1, yend = AD.PM.Max.M + seg.max.2), 
               color = "black", size = 0.4, lineend = "round") +
  geom_segment(data = subset(fig.4a.data.1, Sex == "M"),
               aes(x = 1.824, xend = 2.175, y = max(as.matrix(fig.4a.data.1[,Outcome]), na.rm = TRUE) + seg.max.1, yend = max(as.matrix(fig.4a.data.1[,Outcome]), na.rm = TRUE) + seg.max.1), 
               color = "black", size = 0.4, lineend = "round") + 
  geom_segment(data = subset(fig.4a.data.1, Sex == "M"),
               aes(x = 1.825, xend = 1.825, y = max(as.matrix(fig.4a.data.1[,Outcome]), na.rm = TRUE) + seg.max.1, yend = WT.FA.Max.M + seg.max.2), 
               color = "black", size = 0.4, lineend = "round") +
  geom_segment(data = subset(fig.4a.data.1, Sex == "M"),
               aes(x = 2.175, xend = 2.175, y = max(as.matrix(fig.4a.data.1[,Outcome]), na.rm = TRUE) + seg.max.1, yend = WT.PM.Max.M + seg.max.2), 
               color = "black", size = 0.4, lineend = "round") +
  geom_text(data = subset(fig.4a.data.1, Sex == "F"),
            aes(x = 1, y = max(as.matrix(fig.4a.data.1[,Outcome]), na.rm = TRUE) + text.above.1, label = "NS"), color = "black", size = 2.5, vjust = 0) +
  geom_text(data = subset(fig.4a.data.1, Sex == "F"),
            aes(x = 2, y = max(as.matrix(fig.4a.data.1[,Outcome]), na.rm = TRUE) + text.above.1, label = "NS"), color = "black", size = 2.5, vjust = 0) +
  geom_text(data = subset(fig.4a.data.1, Sex == "M"),
            aes(x = 1, y = max(as.matrix(fig.4a.data.1[,Outcome]), na.rm = TRUE) + text.above.1, label = "NS"), color = "black", size = 2.5, vjust = 0) +
  geom_text(data = subset(fig.4a.data.1, Sex == "M"),
            aes(x = 2, y = max(as.matrix(fig.4a.data.1[,Outcome]), na.rm = TRUE) + text.above.1, label = "NS"), color = "black", size = 2.5, vjust = 0) +
  geom_text(data = subset(fig.4a.data.1, Sex == "F"),
            aes(x = 2.32, y = max(as.matrix(fig.4a.data.1[,Outcome]), na.rm = TRUE) + text.corner.1, label = "* Exposure"), color = "black", size = 2.5, hjust = 0, vjust = 0) +
  geom_text(data = subset(fig.4a.data.1, Sex == "M"),
            aes(x = 2.32, y = max(as.matrix(fig.4a.data.1[,Outcome]), na.rm = TRUE) + text.corner.1, label = "* Exposure"), color = "black", size = 2.5, hjust = 0, vjust = 0) +
  geom_text(data = subset(fig.4a.data.1, Sex == "F"),
            aes(x = 2.32, y = max(as.matrix(fig.4a.data.1[,Outcome]), na.rm = TRUE) + text.corner.2, label = "** Sex"), color = "black", size = 2.5, hjust = 0, vjust = 0) +
  geom_text(data = subset(fig.4a.data.1, Sex == "M"),
            aes(x = 2.32, y = max(as.matrix(fig.4a.data.1[,Outcome]), na.rm = TRUE) + text.corner.2, label = "** Sex"), color = "black", size = 2.5, hjust = 0, vjust = 0) +
  geom_text(data = subset(fig.4a.data.1, Sex == "F"),
            aes(x = 2.32, y = max(as.matrix(fig.4a.data.1[,Outcome]), na.rm = TRUE) + 0.001, label = "# Genotype:Exposure"), color = "black", size = 2.5, hjust = 0, vjust = 0) +
  geom_text(data = subset(fig.4a.data.1, Sex == "M"),
            aes(x = 2.32, y = max(as.matrix(fig.4a.data.1[,Outcome]), na.rm = TRUE) + 0.001, label = "# Genotype:Exposure"), color = "black", size = 2.5, hjust = 0, vjust = 0) 
