...
# Group Sex
fig.3.data.2 <- fig.3.data.2[-which(is.na(fig.3.data.2$Abeta.42)),]
...
Figure3A.10 <- ggplot(data = fig.3.data.2[which(fig.3.data.2$Organ == "Brain"),], aes(x = Genotype, y = !!sym(Outcome), fill = Exposure)) +
