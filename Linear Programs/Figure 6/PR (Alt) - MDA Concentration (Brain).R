####################################################
### Figure 6PR (Alt) - MDA Concentration (Brain) ###
####################################################
...
Figure6A.10 <- ggplot(data = fig.6.gsh.data.1[which(fig.6.gsh.data.1$Organ == "Brain"),], aes(x = Genotype, y = !!sym(Outcome), fill = Exposure)) +
