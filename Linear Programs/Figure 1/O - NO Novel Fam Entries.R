#######################################
### Figure 1O: NO Novel Fam Entries ###
#######################################
...
Figure1A.12 <- ggplot(data = fig.1.data.1, aes(x = Genotype, y = !!sym(Outcome), fill = Exposure)) +
  ...
  scale_y_continuous(breaks = seq(0, 7, 0.2)) +
  ...
  xlab("Genotype") + ylab("Novel : Familiar Entries") + 
